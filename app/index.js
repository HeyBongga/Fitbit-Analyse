...
import { initProfile } from "./metrics/profile";
...
//   btn.text = running ? "STOP" : "START";

//   if (running) startLogging();
//   else stopLogging();
// };
...
// }
function showPage(index) {
  page0.style.visibility = (index === 0) ? "visible" : "hidden";
  page1.style.visibility = (index === 1) ? "visible" : "hidden";
  page2.style.visibility = (index === 2) ? "visible" : "hidden";
}
